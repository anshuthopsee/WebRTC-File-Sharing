...
To access the site from another device, which is not your server, find out your IP Address and in the index.js file change  the WebSocket connection url with your IP Address, like so.
```javascript
